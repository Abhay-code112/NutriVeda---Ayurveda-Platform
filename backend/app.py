...
try:
    ...
    try:
        ...
        # Create dummy models if database doesn't exist
        class Patient:
            objects = type('objects', (), {'count': lambda: 0, 'all': lambda: [], 'get': lambda x: None, 'create': lambda **kwargs: None})()
        class FoodItem:
            objects = type('objects', (), {'count': lambda: 0, 'all': lambda: [], 'filter': lambda **kwargs: type('QuerySet', (), {'count': lambda: 0})()})()
        class DietChart:
            objects = type('objects', (), {'count': lambda: 0, 'all': lambda: [], 'create': lambda **kwargs: None})()
        class DoshaAssessment:
            objects = type('objects', (), {'count': lambda: 0, 'create': lambda **kwargs: None})()
...
urlpatterns = [
    ...
    path('api/dosha-assessment/', dosha_assessment_api, name='dosha_assessment'),
...
# Database is initialized via setup_database.py
...
if __name__ == '__main__':
    ...
    print(f"🕉️  NutriVeda Backend starting on port {port}")
